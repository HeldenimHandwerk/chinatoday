    ...
    <div className="container mx-auto h-full px-4 py-6 md:px-12">
      <div className="flex flex-col justify-center text-left">
        ...
        <div className="mt-8 rounded-lg bg-white p-5 shadow">
          ...
          <p className="mt-2 text-gray-600">Vercel</p>
          ...
          <p className="mt-2 text-gray-600">
            ...
            <br />
            <br />
            Gutzkowstra&szlig;e 3, 60594, Frankfurt am Main
          </p>
          <p className="mt-2 text-gray-600">
            Telefon: 0174 2444987
            <br />
            E-Mail: info@helden-im-handwerk.de
          </p>
          <p className="mt-2 text-gray-600">
          ...
          <p className="mt-2 text-gray-600">
            ...
            k&ouml;nnen. Die so erfassten Daten werden gespeichert, bis Sie uns
            zur L&ouml;schung auffordern, das Usercentrics-Cookie selbst
          ...
          <p className="mt-2 text-gray-600">
            ...
            Verhalten der Websitebesucher zu analysieren. Hierbei erh&auml;lt
            ...
            des Nutzers. Diese Daten werden dem jeweiligen Endgerät des Users
            zugeordnet. Eine Zuordnung zu einer User-ID erfolgt nicht.
          </p>{' '}
          <p className="mt-2 text-gray-600">
            Des Weiteren k&ouml;nnen wir mit Google Analytics u.&nbsp;a. Ihre
            Maus- und Scrollbewegungen und Klicks aufzeichnen. Ferner verwendet
            Google Analytics verschiedene Modellierungsans&auml;tze, um die
            erfassten Datens&auml;tze zu erg&auml;nzen und setzt
          ...
          <p className="mt-2 text-gray-600">
            ...
            erfassten Informationen &uuml;ber die Benutzung dieser Website
          ...
          <p className="mt-2 text-gray-600">
            ...
            Abkommens &uuml;ber den Europ&auml;ischen Wirtschaftsraum vor der
            &Uuml;bermittlung in die USA gek&uuml;rzt. Nur in
          ...
          <p className="mt-2 text-gray-600">
            ...
            Sie der Inhaber der angegebenen E-Mail-Adresse und mit dem Empfang
            des Newsletters einverstanden sind. Weitere Daten werden nicht bzw.
            nur auf freiwilliger Basis erhoben. F&uuml;r die Abwicklung der
            Newsletter nutzen wir Newsletterdiensteanbieter, die nachfolgend
            beschrieben werden.
          </p>
          <h3 className="mt-3 text-2xl font-medium text-gray-500">
          ...
          <p className="mt-2 text-gray-600">
            Diese Website nutzt die Dienste von Mailchimp f&uuml;r den Versand
            von Newslettern. Anbieter ist die Rocket Science Group LLC, 675
            Ponce De Leon Ave NE, Suite 5000, Atlanta, GA 30308, USA.
          </p>{' '}
          <p className="mt-2 text-gray-600">
            Mailchimp ist ein Dienst, mit dem u.a. der Versand von Newslettern
            organisiert werden kann. Wenn Sie Daten zum Zwecke des
            Newsletterbezugs eingeben (z.&nbsp;B. E-Mail-Adresse), werden diese
            auf den Servern von Mailchimp in den USA gespeichert. Wir haben die
            Erfolgsmessung bei Mailchimp deaktiviert, sodass Mailchimp ihr
            Verhalten beim &Ouml;ffnen unserer Newsletter nicht auswerten wird.
          </p>{' '}
          <p className="mt-2 text-gray-600">
            Wenn Sie nicht m&ouml;chten, dass Ihre Daten an Mailchimp
            &uuml;bertragen werden, m&uuml;ssen Sie den Newsletter abbestellen.
            Hierf&uuml;r stellen wir in jeder Newsletternachricht einen
            entsprechenden Link zur Verf&uuml;gung.
          </p>{' '}
          <p className="mt-2 text-gray-600">
